...
export default function Quiz6(){
    ...
    if (currentStage === 'result'){
        currentStageDisplay = <QuizEnd url='Quiz6' totalCorrect={correctCounter} />
    }
    ...
    async function fetchQuiz(){
        let response = await fetch('https://opentdb.com/api.php?amount=10&category=27&type=multiple')
